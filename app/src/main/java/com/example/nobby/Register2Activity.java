...
public class Register2Activity extends AppCompatActivity implements AdapterView.
        OnItemSelectedListener {
    private EditText etCurp, etAddress, etNumber;
    private TextView tvDate;
    private String ssCurp, ssAddress, ssNumber, ssDate, ssName, ssEmail, ssPassword, ssPassword2, ssState, ssDegree;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getStrings();
                String formatRegister = "E/signup/"+ssEmail+","
    ...
    /*private void dbConnection(URL dbRegister) throws IOException {
        HttpsURLConnection nbConnection = (HttpsURLConnection) dbRegister.openConnection();
        InputStream isReader = new BufferedInputStream(nbConnection.getInputStream());
        String respuesta = "respuesta";
        respuesta = String.valueOf(isReader.read());
        isReader.close();
        nbConnection.disconnect();
    }*/
    ...
    private void getStrings() {
        ...
        ssPassword = getIntent().getStringExtra("Password1");
        ssPassword2 = getIntent().getStringExtra("Password2");
    }
